# Time triggered system - Example 3
...
- ../picotool/picotool.exe uf2 convert bin/time_triggered_system_3 -t elf bin/time_triggered_system_3.uf2
- ../picotool/picotool.exe load bin/time_triggered_system_3.uf2
